...
reference_stockfish = engine("lc0_256x20-t40-1541", "lc0_256x20-t40-1541.bat")
lc0_new = engine("lc0_128x10-PB04-CCRL-swa-50000", "lc0_128x10-PB04-CCRL-swa-50000.bat")
lc0 = engine("128x10-BPR-64M-6430000", "lc0_703350.bat")
engines = [reference_stockfish, lc0_new, lc0]
...
for i in range(10000):
    ...
    while not board.is_game_over():
        e1s = time()
        m = engine1.en.play(board, ce.Limit(nodes=1000)) #ce.Limit(white_clock=wc, black_clock=bc)
        board.push(m.move)
